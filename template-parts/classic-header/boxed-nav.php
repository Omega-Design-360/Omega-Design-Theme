<?php
/**
 * Omega Design - Classic Header, Style 4: Boxed Nav
 *
 ...
 * variant class (.omega-classic-header--4) lives in
...
?>
<header class="site-header omega-classic-header omega-classic-header--4<?php echo $sticky ? ' omega-classic-header--sticky' : ''; ?>">
