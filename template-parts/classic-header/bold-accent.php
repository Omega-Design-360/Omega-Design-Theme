<?php
/**
 * Omega Design - Classic Header, Style 5: Bold Accent
 *
 ...
 * variant class (.omega-classic-header--5) lives in
...
?>
<header class="site-header omega-classic-header omega-classic-header--5<?php echo $sticky ? ' omega-classic-header--sticky' : ''; ?>">
