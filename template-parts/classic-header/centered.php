<?php
/**
 * Omega Design - Classic Header, Style 2: Centered
 *
 ...
 * variant class (.omega-classic-header--2) lives in
...
?>
<header class="site-header omega-classic-header omega-classic-header--2<?php echo $sticky ? ' omega-classic-header--sticky' : ''; ?>">
