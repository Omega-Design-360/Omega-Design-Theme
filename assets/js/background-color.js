( function ( wp ) {
	...
	// content-width -> background-color), so by the time it runs, both of
	// the other controls have already registered themselves on the shared
	// namespace, and PageSettingsPanel can combine all three.
