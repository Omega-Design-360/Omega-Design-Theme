( function ( wp ) {
	...
	// content-width -> hide-header -> hide-footer -> background-color), so
	// by the time it runs, every other control has already registered
	// itself on the shared namespace, and PageSettingsPanel can combine
	// all of them.
